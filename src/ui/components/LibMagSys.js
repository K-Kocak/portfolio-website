        ...
        return (
            <div id="libmagsys" className="libmagsys">
                <div className="libmagsys_container">
                    ...
                    <p className="project_description_content">A Library Management System for managing a database of books with its authors and genres stored, and allowing these books to be issued to members as well as manage returned and lost books from members.</p>
                    </div>
                </div>
            </div>
        )
