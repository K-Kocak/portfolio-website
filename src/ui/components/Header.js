                ...
                <div className="header_container">
                    <div className="header_items">
                        ...
                        <div className="header_description">
                            <p>[PLACEHOLDER]As a recent Mathematics graduate from the University of York, I bring a solid foundation in analytical thinking and problem-solving to IT. With self-honed programming skills, developed critical thinking, and effective communication abilities gained through my surroundings, I am skilled at navigating complex challenges, collaborating with teams, and providing support to users. I am a passionate graduate and eager to further develop my expertise in the world of software. Motivated by a desire to contribute to software development, I am seeking opportunities that allow me to expand my skills while providing openings for professional growth and development. Committed to embracing new challenges, I am passionate to embark on this next chapter of my career journey.[PLACEHOLDER]</p>
                        </div>
